...
//         if (request.query.categoria !='Ver todas las actividades') {
//             if (request.query.categoria != 'Ver todas las actividades' && request.query.provincia == "") {
...
//                 }
//             } else if (request.query.categoria != 'Ver todas las actividades' && request.query.provincia != "") {
